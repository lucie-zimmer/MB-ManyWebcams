...
h2.rand.model.beta <- glmmTMB(percorr ~  method + (1|lab), data = mdata, family = beta_family())
...
h2.rand.model.beta.trial.age <- glmmTMB(lookingscore ~  z_age + method + z_trial_num+  (z_age|lab) + (z_trial_num|subid), data = data_trial_by_trial, family = beta_family())

summary(h2.rand.model.beta.trial.age)
```
