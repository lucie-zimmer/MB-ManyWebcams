...
ManyWebcams: 60% included; exclusion due to technical problems (n= 15), low sampling rate (n= 3), manual exclusion: interference (n = 2) # THIS NEEDS TO BE UPDATED
ManyBabies2 Pilot: 89.04% included; exclusion due to early termination (n = 6), technical problems (n= 2)

```{r}
# TODO: Redo this entire segment
